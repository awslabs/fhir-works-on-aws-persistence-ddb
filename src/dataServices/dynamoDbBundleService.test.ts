...
describe('atomicallyReadWriteResources', () => {
    ...
    describe('SUCCESS Cases', () => {
        ...
        async function runUpdateTest(
            ...
            shouldReqHaveTTLInSeconds: boolean,
            ...
            const transactionService = new DynamoDbBundleService(dynamoDb, false, undefined, ttlsInSeconds, {
                versionedLinks,
            });
        ...
        test('UPDATING a resource with references and versioned reference links', async () => {
            await runUpdateTest(true, true, true);
        });
    });
    ...
    describe('Bundle transaction with multiple resources', () => {
        async function runTransaction(
            ...
            const transactionService = new DynamoDbBundleService(dynamoDb, supportUpdateCreate, undefined, undefined, {
                versionedLinks,
            });
